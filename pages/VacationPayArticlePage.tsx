...
const VacationPayArticlePage: React.FC<VacationPayArticlePageProps> = ({ onNavigate }) => {
  const vacationFaqs = [
    {
      q: "Can I pay vacation pay on each paycheque?",
      a: "Yes. It's common for hourly or casual staff. You'll need to clearly separate the 'Vacation Pay' line item on the pay stub (usually 4%). Just remember that for paying vacation pay on each cheque or during/after vacation, a written agreement with the employee's often required."
    },
    {
      q: "Do I have to pay vacation pay on overtime earnings?",
      a: "Yes. Vacation pay's calculated on 'gross wages,' which includes overtime pay, public holiday pay, and commissions."
    },
    {
      q: "What happens to vacation pay when an employee quits?",
      a: "All accrued and unpaid vacation pay has to be paid out on their final paycheque. It's a strict requirement under Employment Standards."
    },
    {
      q: "Can I enforce a 'Use it or Lose it' policy?",
      a: "You can generally enforce a 'use it or lose it' policy for the *time off*, but you CAN'T force them to lose the *money*. Any unpaid vacation pay must be paid out, even if they didn't take the days."
    },
    {
      q: "Does vacation pay accrue during a sick leave?",
      a: "Generally, no. Vacation pay's a percentage of *wages earned*. If the employee's on unpaid sick leave and earning $0, they're accruing $0 in vacation pay (though they might still accumulate 'years of service')."
    },
    {
      q: "Is vacation pay pensionable (CPP) and insurable (EI)?",
      a: "Yes. When vacation pay's paid out, it's considered income. You'll need to deduct CPP, EI, and Income Tax from it."
    },
    {
      q: "How does vacation pay work for part-time staff?",
      a: "Part-time staff're entitled to the same percentage (usually 4%) as full-time staff. Because it's a percentage of their earnings, it naturally pro-rates based on the hours they work."
    },
    {
      q: "When does the rate increase from 4% to 6%?",
      a: "In most provinces (like Ontario and BC), the entitlement increases to 3 weeks of time and 6% pay after 5 consecutive years with the same employer."
    },
    {
      q: "Can I include vacation pay in an employee's salary?",
      a: "You can state that a salary's 'inclusive' of vacation pay, but you'll need to ensure the base pay's high enough to cover the legal minimums. If they earn a bonus, you still owe 4% on that bonus regardless of the contract."
    },
    {
      q: "What's a 'Vacation Year'?",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl lg:text-[5.5rem] font-black text-white mb-8 leading-[0.95] tracking-tighter uppercase">
              How's Vacation Pay <br/>
              <span className="text-red-500">Actually Working?</span>
            </h1>
            <p className="text-xl text-slate-300 leading-relaxed font-medium mb-10">
              It's the #1 source of payroll discrepancies in Canada. Here's the definitive guide to "Time Off" vs "Vacation Pay" and the compliance traps most businesses miss regarding commissions, bonuses, and termination.
            </p>
          ...
          <div className="lg:col-span-8">
            <div className="prose prose-lg prose-slate max-w-none">
              <p className="text-xl font-medium text-slate-900 mb-8 leading-relaxed border-l-4 border-red-600 pl-6">
                In Canada, the answer depends on how you've structured your pay, but legally speaking, <strong>vacation pay's always earned in addition to your regular wages.</strong>
              </p>

              <p className="text-slate-600 mb-8">
                It’s helpful to think of vacation entitlement as two separate buckets: <strong>Vacation Time</strong> (the days off) and <strong>Vacation Pay</strong> (the money). Under most provincial laws (like Ontario's <em>Employment Standards Act</em>), an employee with less than 5 years of service's entitled to 2 weeks of vacation time and <strong>4% vacation pay</strong>.
              </p>
              ...
              <p className="text-slate-600 mb-8">
                Most employers tell salaried staff: "You get $60,000 a year, and that includes your 2 weeks of vacation." This's compliant, <strong>provided the employee only earns their base salary.</strong>
              </p>
              <p className="text-slate-600 mb-6">
                The compliance trap snaps shut the moment that employee earns a performance bonus, overtime pay, or a commission. Vacation pay's calculated on <em>gross</em> wages, not just base salary.
              </p>
              ...
              <div className="bg-slate-50 p-8 border-l-4 border-slate-900 mb-12">
                 ...
                 <p className="text-slate-600 text-sm mb-4">
                   Jane earns a $60,000 salary. Her employer continues to pay her regular salary while she's away for 2 weeks in July. The vacation pay on her base salary's considered "paid."
                 </p>
                 <p className="text-slate-600 text-sm mb-4">
                   However, in December, Jane earns a <strong>$10,000 performance bonus</strong>.
                 </p>
                 <p className="text-red-600 font-bold text-sm">
                   THE MISTAKE: <span className="text-slate-600 font-normal">The employer pays her $10,000 and thinks they're done.</span>
                 </p>
                 <p className="text-green-600 font-bold text-sm">
                   THE LAW: <span className="text-slate-600 font-normal">Jane's owed 4% on <strong>all</strong> earnings. The employer owes her an additional <strong>$400</strong> (4% of the $10k bonus) as vacation pay. This's often missed, leading to cumulative liabilities over years.</span>
                 </p>
              </div>
              ...
              <p className="text-slate-600 mb-6">
                Commissioned employees're the most frequently underpaid group regarding vacation pay. Because their income fluctuates, employers often fail to calculate the "time off" value of those commissions.
              </p>
              <p className="text-slate-600 mb-6">
                If a salesperson takes 2 weeks off, they typically earn $0 in commissions during that time. Therefore, their "Vacation Pay" bucket's gotta be filled by the percentage earned on their closed deals throughout the year.
              </p>
              ...
              <div className="bg-slate-50 p-8 border-l-4 border-red-600 mb-12">
                 ...
                 <p className="text-slate-600 text-sm mb-4">
                   Mike's a sales rep earning 100% commission. He sells $200,000 worth of commissions in a year. 
                   <br/>
                   <span className="font-bold text-slate-900">Important Math:</span> The 4% vacation pay's calculated on the <span className="underline decoration-red-500 decoration-2 font-bold">full $200,000</span> of commissions. This means Mike's legally owed an additional <span className="font-bold text-red-600">$8,000</span> (4% of $200k) on top of his sales earnings.
                 </p>
                 <div className="grid md:grid-cols-2 gap-6 mt-6">
                    <div>
                        <p className="font-bold text-xs uppercase tracking-widest text-slate-400 mb-2">Method A: Paid on Each Pay</p>
                        <p className="text-sm text-slate-600">
                          The employer adds 4% to every commission cheque. Mike gets $208,000 total cash. <br/><br/>
                          <strong>The Reality:</strong> When Mike takes 2 weeks off in August, he receives <strong>$0 pay</strong> for those weeks, because his vacation money's already been paid out on every previous cheque. Mike's gotta budget for this himself.
                        </p>
                    </div>
                    <div>
                        ...
                        <p className="text-sm text-slate-600">
                          ...
                          <strong>The Reality:</strong> When Mike takes 2 weeks off, the employer releases the <strong>$8,000</strong> to him so he's got a "paycheque" while sitting on the beach.
                        </p>
                    </div>
                 </div>
                 <div className="mt-8 bg-amber-50 p-4 border border-amber-200">
                    <p className="text-xs font-bold text-amber-900 uppercase tracking-widest mb-1">Written Agreement Required</p>
                    <p className="text-xs text-amber-800 leading-relaxed font-medium italic">
                      "For paying vacation pay on each pay or during/after vacation, a written agreement with the employee's often required by provincial employment standards."
                    </p>
                 </div>
              </div>
              ...
              <p className="text-slate-600 mb-6">
                When an employee's terminated without cause, they're owed "pay in lieu of notice" (Termination Pay). In many jurisdictions (including Ontario and BC), <strong>vacation pay has to be calculated on the termination pay itself.</strong>
              </p>
              <p className="text-slate-600 mb-6">
                Since termination pay's considered "wages" or "earnings" under the Employment Standards Act, it attracts vacation pay just like regular salary's going to.
              </p>
              ...
              <div className="bg-slate-900 text-white p-8 mb-6">
                 ...
                 <p className="mt-6 text-xs text-slate-400 italic">
                   *This $400's frequently missed by DIY employers. If the employee files a Ministry claim, the employer's often audited for <strong>all</strong> employees, not just the one who was fired.
                 </p>
              </div>
              ...
              <div className="bg-red-50 border-l-4 border-red-600 p-6 my-10">
                ...
                <p className="text-slate-700 text-sm leading-relaxed font-bold">
                  Crucial: Vacation pay's got to be calculated on termination pay (pay in lieu of notice) just as it is on regular salary. 
              ...
              <p className="text-slate-600 mb-6">
                In Canada, the short answer's <strong>no</strong>. Employees can't waive their legal right to vacation pay, even if they sign a contract agreeing to do so.
              </p>
              <p className="text-slate-600 mb-6">
                In the eyes of the law, vacation pay's a <strong>minimum standard</strong>, not a negotiable benefit. Here's how the law prevents you from "contracting out" of these obligations:
              </p>

              <h3 className="text-xl font-bold text-slate-900 mt-8 mb-4">1. The "No Contracting Out" Rule</h3>
              <p className="text-slate-600 mb-4">
                Most provincial laws (such as Ontario’s <em>Employment Standards Act</em>) and the federal <em>Canada Labour Code</em>'ve got a specific "no contracting out" provision. This means:
              </p>
              <ul className="list-disc pl-6 text-slate-600 mb-6 space-y-2">
                <li>An employment contract's <strong>void</strong> if it offers less than the legal minimum.</li>
                <li>Even if an employee willingly signs a contract that says "I waive my 4% vacation pay," that clause isn't legally enforceable.</li>
                <li>They can't "trade" their vacation pay for other perks (like a slightly higher salary) if it brings their total compensation below the legal minimums + 4%.</li>
              </ul>

              <h3 className="text-xl font-bold text-slate-900 mt-8 mb-4">2. Vacation Time vs. Vacation Pay</h3>
              <p className="text-slate-600 mb-4">
                There's a slight nuance between waiving <strong>time</strong> and waiving <strong>money</strong>:
              </p>
              <ul className="list-disc pl-6 text-slate-600 mb-6 space-y-2">
                <li><strong>Vacation Time:</strong> In some jurisdictions (like the Federal level or Ontario), you're sometimes able to allow an employee to waive their <strong>time off</strong> (the actual days away from work) if agreed in writing and approved by the Director (where applicable).</li>
              ...
              <p className="text-slate-600 mb-4">
                Some employers have policies stating that if staff don't use vacation by year-end, they'll lose it.
              </p>
              <ul className="list-disc pl-6 text-slate-600 mb-6 space-y-2">
                <li><strong>Legality:</strong> You're often able to force them to "lose" the <strong>time</strong> (i.e., you're not obligated to let them carry days over to next year).</li>
                <li><strong>The Catch:</strong> You <strong>can't</strong> make them lose the <strong>pay</strong>. If they didn't take their vacation days, you've still got to pay out the accrued 4% (or 6% for long-term staff) at the end of the year or upon termination.</li>
              </ul>

              <h3 className="text-xl font-bold text-slate-900 mt-8 mb-4">4. Using "Inclusive" Contracts</h3>
              <p className="text-slate-600 mb-4">
                Employers often try to write contracts stating that the annual salary's "inclusive of all vacation pay."
              </p>
              <ul className="list-disc pl-6 text-slate-600 mb-6 space-y-2">
                <li><strong>Is this legal?</strong> Generally, yes, but only if the math works out. The base salary's got to be clearly high enough that the 4%'s accounted for.</li>
                <li><strong>The Risk for Employers:</strong> If the contract's vague or if the employee earns "extra" money (like a bonus or overtime), you still owe 4% on that extra money. You can't argue that the base salary covers 4% of a bonus they haven't earned yet.</li>
              </ul>

              <div className="bg-amber-50 p-6 border-l-4 border-amber-500 mb-6">
                <p className="text-sm text-slate-700 leading-relaxed">
                  <strong>Strategic Note:</strong> Generally speaking, while this practice might be legally compliant, it's often seen as <strong>not employee-friendly</strong>. It might not be a good business decision when you're trying to attract top talent. It's wise to consider your objective and what you're really trying to achieve with your compensation strategy.
                </p>
              </div>
                ...
                <table className="min-w-full divide-y divide-slate-200">
                  ...
                  <tbody className="bg-white divide-y divide-slate-100">
                    <tr>
                      ...
                      <td className="px-6 py-4 text-sm text-slate-600">It's got to be paid out, even if they work through vacation.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4 text-sm font-bold text-red-600">NO</td>
                      <td className="px-6 py-4 text-sm text-slate-600">Contracts that offer less than the law're legally void.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-lg font-bold leading-relaxed">
                      Vacation pay's accruing on <strong>every dollar</strong> earned, including bonuses, commissions, and overtime.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium leading-relaxed text-slate-300">
                      Failure to calculate vacation pay on "Termination Pay" (Pay in Lieu of Notice)'s the #1 cause of Labour Board orders against small businesses after a dismissal.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-4 space-y-8">
             <div className="bg-slate-50 p-8 border border-slate-200 sticky top-24">
                ...
                <p className="text-slate-600 text-sm mb-6 leading-relaxed">
                  Vacation accrual on variable income (bonuses, commissions)'s the #1 reason for Ministry of Labour claims against small businesses. 
                </p>
                <div className="space-y-4">
                  <button 
                    onClick={() => onNavigate('calculator')}
